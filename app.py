...
def load_players():
    try:
        ...
        for player in players:
            ...
            if player['grade'] == 'Diamond - A':
                player['base_price'] = 200000
                player['bid_increment'] = 50000
            elif player['grade'] == 'Platinum - B1':
                player['base_price'] = 100000
                player['bid_increment'] = 50000
            elif player['grade'] == 'Platinum - B2':
                player['base_price'] = 100000
                player['bid_increment'] = 25000
            elif player['grade'] == 'Gold - C':
                player['base_price'] = 50000
                player['bid_increment'] = 10000
            elif player['grade'] == 'Silver - D':
                player['base_price'] = 25000
                player['bid_increment'] = 5000
            elif player['grade'] == 'Bronze - E':
                player['base_price'] = 10000
                player['bid_increment'] = 2000
            player['final_bid'] = 0
...
teams = {
    "Wicket Strikers": {"budget": 10000000, "players": [], "grade_count": defaultdict(int)},
    "Raging Hurricanes": {"budget": 10000000, "players": [], "grade_count": defaultdict(int)},
    "Orion Stars": {"budget": 10000000, "players": [], "grade_count": defaultdict(int)},
    "Blazing Thunders": {"budget": 10000000, "players": [], "grade_count": defaultdict(int)},
    "Supreme Scorchers": {"budget": 10000000, "players": [], "grade_count": defaultdict(int)}
}
